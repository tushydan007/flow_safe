...
export const userApi = {
  ...
  updateOrganization: async (data: Partial<Organization>): Promise<ApiResponse<Organization>> => {
    const response = await apiClient.patch<ApiResponse<Organization>>('/auth/organization/', data);
    return response.data;
  },

  updateOrganizationLogo: async (file: File): Promise<ApiResponse<Organization>> => {
  ...
  updateSettings: async (data: Partial<UserSettings>): Promise<ApiResponse<UserSettings>> => {
    const response = await apiClient.patch<ApiResponse<UserSettings>>('/auth/settings/', data);
    return response.data;
  },
};
