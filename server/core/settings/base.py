...
# File upload settings - support for large TIFF files
...
CELERY_WORKER_MAX_MEMORY_PER_CHILD = 1024 * 1024  # 1GB

# GDAL settings - handle Windows/Linux differences
...
ALLOWED_RASTER_EXTENSIONS = ['.tif', '.tiff', '.TIF', '.TIFF']
ALLOWED_VECTOR_EXTENSIONS = ['.shp', '.geojson', '.json', '.gpkg']

# Analysis settings
ANALYSIS_CHUNK_SIZE = 1024  # Process images in 1024x1024 chunks
ANALYSIS_OVERLAP = 64  # Overlap between chunks to avoid edge artifacts
